...
{
    public partial class REP_Sales : Form
    {
        ...
        private void REP_Sales_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void REP_Sales_Load(object sender, EventArgs e)
        {

                dgList.Sort(dgList.Columns["تاريخ البيع"], ListSortDirection.Descending); // للعرض من من أحدث تاريخ   
            ...
            foreach (DataGridViewColumn col in dgList.Columns)
                ...
                this.dgList.Columns["نسبةالضريبة%"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                ...
                this.dgList.Columns["تاريخ البيع"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
        ...
        private void T_Search_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                da = new SqlDataAdapter(@"select 
                    ...
                    Discount as 'الخصم' , 
                    Vatpercent as 'نسبةالضريبة%' ,
                    VatValue as 'قيمة الضريبة' ,
                    AllTotal as 'المجموع' ,
                    DTM_Sale as 'تاريخ البيع' ,
        ...
        private void PrintAll_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                da.Fill(ds, "TB_Sales");
                REP.Sales1 ORD = new REP.Sales1();  // اسم الكريستال
